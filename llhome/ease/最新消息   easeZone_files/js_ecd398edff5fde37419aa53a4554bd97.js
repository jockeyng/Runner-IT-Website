...
;
Drupal.locale = { 'pluralFormula': function($n) { return Number(1); }, 'strings': { "Unspecified error": "發生不明錯誤", "An error occurred. \n@uri\n@text": "發生了一個錯誤： \n@uri\n@text", "An error occurred. \n@uri\n(no information available).": "發生了一個錯誤：\n@uri\n(無法取得任何訊息).", "An HTTP error @status occurred. \n@uri": "發生了一個HTTP錯誤@status： \n@uri", "Drag to re-order": "抓取項目進行重新排列", "Changes made in this table will not be saved until the form is submitted.": "在送出這個表單之前，這個表格中的變更不會被儲存。", "Select all rows in this table": "選取表格中的所有列", "Deselect all rows in this table": "取消烜區表格中的所有列", "Split summary at cursor": "將游標之前的內容設定為文章摘要", "Join summary": "將摘要整合到全文裡（顯示全文）", "Save": "儲存", "Your server has been successfully tested to support this feature.": "你的伺服器已經成功地通過測試，可以支援此功能。", "Your system configuration does not currently support this feature. The \x3ca href=\"http://drupal.org/node/15365\"\x3ehandbook page on Clean URLs\x3c/a\x3e has additional troubleshooting information.": "你的系統設定目前並不支援此功能。\x3ca href=\"http://drupal.org/node/15365\"\x3e關於簡潔網址的說明文件\x3c/a\x3e有更多的障礙排除說明。", "Testing clean URLs...": "測試簡潔網址...", "Upload": "上傳", "Only files with the following extensions are allowed: %files-allowed.": "僅允許下列延伸檔名：%files-allowed。", "The changes to these blocks will not be saved until the \x3cem\x3eSave blocks\x3c/em\x3e button is clicked.": "這些區塊的變更不會被儲存起來，除非您按下\x3cem\x3e儲存區塊\x3c/em\x3e 的按鈕。", "Please select a file.": "請選擇一個檔案", "You are not allowed to operate on more than %num files.": "你不可以同時操作多於 %num 個檔案。", "Please specify dimensions within the allowed range that is from 1x1 to @dimensions.": "請指定尺寸在容許的範圍，即是從 1x1 至 @dimensions。", "unlimited": "無限", "%filename is not an image.": "%filename 不是一個圖片。", "Directory %dir is loaded.": "目錄 %dir 已載入。", "Directory %dir is empty.": "目錄 %dir 是空的。", "File browsing is disabled in directory %dir.": "目錄 %dir 的檔案瀏覽功能已關閉。", "You can\'t perform this operation.": "你不能執行這個操作。", "Do you want to refresh the current directory?": "你要重新整理目前的目錄嗎？", "Uploading %filename...": "正在上載 %filename...", "Delete selected files?": "刪除選擇的檔案？", "Please select a thumbnail.": "請選擇一個縮圖。", "Please select a single file.": "請選擇一個檔案。", "You must select at least %num files.": "你必須要選擇最少 %num 個檔案。", "Send to @app": "傳送至 @app", "textarea": "文字區域", "Close": "關閉", "Save and send": "儲存並送出", "Save and send test": "儲存並送出測試", "Next": "下一步" } };;

if (Drupal.jsEnabled) {
  
  Drupal.behaviors.manageSignup = function (context) {
    $('.view-signup-display-id-page_2 table.views-table').each(function () {
      console.log(Drupal.settings);
      $('tbody tr', this).each(function () {
        $(this).addClass(Drupal.settings.manageSignup[$('td.views-field-field-confirmed-value', this).html()]);
      })
    });
  };
